EVALUATE_TEMPLATE = """
To begin with, it is crucial to carefully read and understand the information presented in the history. This will allow you \
 to summarize the interview evaluation and provide expert feedback and suggestions for improvement by combining the \
 Q&A and question description.
...
{{
     ...
     "bad case": string \\ The areas where you believe the questions asked to the interviewer during the entire \
...
Remember: "high_lights" and "bad case" and "explanation" should be human-like text.
