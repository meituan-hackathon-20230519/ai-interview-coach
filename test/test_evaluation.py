...
class EvaluationGenerateTestCase(unittest.TestCase):
    ...
    def test_generate_work_experience(self):
        ...
        self.generator.update_stage_cache(session_id, stage)
    ...
    def test_generate_total_interview(self):
        ...
        history = [[
            ...
            "项目中遇到的最大的挑战是什么？",
            """
            遇到最大的挑战是时间紧迫，人力资源上的问题。
            """
        ], [
            "可以描述一下你如何解决这个问题的吗？",
            """
            我首先调整了项目计划和重新协调我们的人员资源来确保项目能够及时完成，并与不同团队中的技术负责人进行了交流，保证技术实现进度。
            """
        ], [
            "那你从中获得了什么经验",
            """
            我从这个项目中学到了管控、沟通和解决问题的能力，以及在危机管理中的灵活应对能力和决策能力。
            """
        ], [
            "可以说下你对自己未来3-5年的规划吗？",
            """
